...
function Sidebar() {
  return (
    <aside className="relative flex flex-col gap-10 lg:gap-0 lg:justify-between lg:min-h-0 lg:sticky lg:top-0 lg:h-screen lg:overflow-y-auto px-6 md:px-10 py-16 lg:py-20 border-b lg:border-b-0 lg:border-l border-cream/10 order-1 lg:order-last lg:bg-[#1B4332] lg:z-10 lg:rounded-l-xl lg:shadow-[-8px_0_24px_rgba(0,0,0,0.15)]">
      <div>
      ...
      <div className="mt-10 lg:mt-0 flex flex-col gap-3">
        ...
        <div className="mt-6 flex items-center gap-4">
          ...
          <img
            ...
            className="shrink-0 w-full max-w-[120px] aspect-square rounded-full object-cover border-2 border-[#C0281E] shadow-[0_4px_16px_rgba(0,0,0,0.4)] hover:scale-105 transition-all duration-[400ms] ease-out"
          />
        </div>
      </div>
    </aside>
