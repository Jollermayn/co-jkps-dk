...
function Sidebar() {
  return (
    <aside className="flex flex-col gap-10 lg:justify-between lg:min-h-0 lg:sticky lg:top-0 lg:h-screen lg:overflow-y-auto px-6 md:px-10 py-16 lg:py-20 border-b lg:border-b-0 lg:border-l border-cream/10 order-1 lg:order-last lg:bg-[#0B0B09]">
      <div>
