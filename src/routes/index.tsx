        ...
        <div className="w-full min-w-0 max-w-full lg:max-w-[60%] lg:w-[60%] order-2 lg:order-none bg-navy-deep lg:mr-[40%]">
          ...
          <section id="om" className="py-16 md:py-20">
            <div className="px-12 md:px-14">
              ...
              <p className="mt-8 text-left" style={{ color: "white", opacity: 0.85, fontSize: "1.1rem", lineHeight: 1.8 }}>
              ...
              <div className="mt-8 max-w-3xl space-y-6">
                ...
                <p style={{ color: "white", opacity: 0.85, fontSize: "1.1rem", lineHeight: 1.8 }}>
                  Mit udgangspunkt er altid mennesket. Ikke brugeren — men personen bag beslutningen, vanen, frustrationen. Jeg finder mønstrene og omsætter dem til design der virker.
                </p>
