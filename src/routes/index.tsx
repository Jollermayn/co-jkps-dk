        ...
        <div className="w-full min-w-0 max-w-full lg:max-w-[60%] lg:w-[60%] order-2 lg:order-none bg-navy-deep lg:mr-[40%]">
          ...
          <section
            ...
            style={{
              ...
              paddingTop: "max(100px, calc(100px + env(safe-area-inset-top)))",
            }}
          >
          ...
          <section id="om" className="pt-20 md:pt-28 pb-16 md:pb-20">
            ...
            <div className="px-12 md:px-14">
              ...
              <div className="mt-8 max-w-3xl space-y-6">
                ...
                <p style={{ color: "white", opacity: 0.85, fontSize: "1.1rem", lineHeight: 1.8 }}>
                  Jeg interesserer mig for mennesker. Ikke <em>brugeren</em>, men personen bag beslutningen, vanen, frustrationen.
                </p>
                <p style={{ color: "white", opacity: 0.85, fontSize: "1.1rem", lineHeight: 1.8 }}>
                  Familiefar, naturmenneske — og det man nok kan kalde en seriøs lytter.
                </p>
              </div>
            </div>
          </section>
