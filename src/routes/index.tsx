...
const OM_MIG_ROTATING_PHRASES: { text: string; color: string }[] = [
  ...
  { text: "design med mening", color: "#C17F3A" },
        ...
        <div className="w-full min-w-0 max-w-full lg:max-w-[60%] lg:w-[60%] order-2 lg:order-none bg-navy-deep lg:mr-[40%]">
          ...
          <section className="pt-16 md:pt-24 pb-0">
            <div className="px-8 sm:px-12 md:px-14">
              <p className="text-left md:text-center text-[clamp(1.1rem,4.5vw,1.4rem)] sm:text-[clamp(1.2rem,3.5vw,2rem)]" style={{ color: "white", lineHeight: 1.3, fontWeight: 600 }}>
