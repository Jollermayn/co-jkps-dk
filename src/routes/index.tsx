            ...
            {c.tags.map((t, i) => {
              ...
              return (
                ...
                >
                  ...
                  {isOpen && hasCases && (
                    <div className="absolute z-40 right-0 lg:right-auto lg:left-0 top-full mt-2 w-[min(18rem,calc(100vw-6rem))] max-w-[calc(100vw-6rem)] bg-navy-deep border border-cream/15 shadow-2xl p-4 animate-in fade-in slide-in-from-top-1 duration-150">
                      <div
