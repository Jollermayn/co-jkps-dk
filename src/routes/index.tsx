...
function Index() {
  return (
    <main id="top" className="w-full min-w-0 max-w-full overflow-x-clip text-cream lg:bg-[#0D1B2A]">
      ...
      <footer className="w-full max-w-full lg:w-[60%] lg:max-w-[60%] py-10 relative z-10 overflow-x-hidden border-t" style={{ backgroundColor: "#0D1B2A", borderTopColor: "rgba(255,255,255,0.1)" }}>
