    ...
    <aside className="hero-sidebar relative w-full min-w-0 max-w-full flex flex-col gap-16 lg:gap-12 lg:fixed lg:top-0 lg:right-0 lg:w-[40%] lg:h-screen lg:overflow-hidden px-6 md:px-14 lg:px-16 py-12 md:py-20 lg:pt-[8vh] lg:pb-16 border-b lg:border-b-0 lg:border-l border-cream/10 order-1 lg:order-last bg-[#0D1B2A] lg:z-20 lg:rounded-l-xl lg:shadow-[-8px_0_24px_rgba(0,0,0,0.25)] text-center items-center lg:justify-start">
      <div className="w-full flex flex-col gap-3 lg:gap-4 items-center text-center">
        <h1 className="font-display tracking-[-0.02em] font-medium text-center px-2 flex flex-col items-center leading-none">
          <span className="block text-[clamp(2.25rem,7.5vw,3.75rem)] leading-none" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 300 }}>Jonas</span>
          <span className="block text-[clamp(2.25rem,7.5vw,3.75rem)] leading-none -mt-[0.08em]" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 300 }}>Sørensen</span>
        </h1>
        ...
        <blockquote className="max-w-full w-full text-center mt-16 lg:mt-10 lg:-translate-y-[15px]">
          <TypewriterQuote />
        </blockquote>
      </div>
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className={
                          "text-[10px] tracking-wide uppercase px-2.5 py-1 rounded-full border-none transition-colors " +
                      ...
                      {isOpen && hasCases && (
                        <div
                          style={{ zIndex: 9999 }}
                          className="absolute top-full left-0 mt-2 w-[calc(100vw-2.5rem)] max-w-[calc(100vw-2.5rem)] md:w-[min(18rem,calc(100vw-6rem))] md:max-w-[calc(100vw-6rem)] bg-navy-deep border border-cream/15 shadow-2xl p-4 animate-in fade-in slide-in-from-top-1 duration-150"
                        >
                          <div
