            ...
            <div className="flex flex-col md:flex-row md:items-center" style={{ width: "100%" }}>
              ...
              <div className="w-full md:w-1/2 flex justify-center md:justify-end order-2 mt-8 md:mt-0">
                <img
                  ...
                  alt=""
                  aria-hidden="true"
                  style={{ display: "block", objectFit: "contain", height: "auto", width: "420px", maxWidth: "100%", marginRight: "-40px", transform: "scaleX(-1)", filter: "drop-shadow(0px 12px 8px rgba(0, 0, 0, 0.25))" }}
                />
              </div>
