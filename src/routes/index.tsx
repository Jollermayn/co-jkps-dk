...
function Index() {
  return (
    <main id="top" className="w-full min-w-0 max-w-full overflow-x-clip text-cream lg:bg-[#0D1B2A]">
        ...
        <div className="w-full min-w-0 max-w-full lg:max-w-[60%] lg:w-[60%] order-2 lg:order-none bg-navy-deep lg:mt-11 lg:rounded-t-xl lg:shadow-[0_-8px_24px_rgba(0,0,0,0.2)] lg:mr-[40%]">
          ...
          <section id="baggrund" className="py-16 md:py-20">
            <div className="px-5 md:px-14">
              ...
              <p className="text-center italic font-display text-cream mx-auto" style={{ fontSize: "24px", lineHeight: 1.4, paddingTop: "48px", maxWidth: "700px" }}>
      ...
      <footer className="w-full max-w-full lg:w-[60%] lg:max-w-[60%] py-10 relative z-10 overflow-x-hidden border-t" style={{ backgroundColor: "#C0281E", borderTopColor: "rgba(255,255,255,0.1)" }}>
        <div className="px-12 md:px-14 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-sm text-white/80">
