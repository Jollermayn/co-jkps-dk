    ...
    <div style={{ backgroundColor: BEIGE, minHeight: "100vh" }}>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .tilgang-hero-img { object-position: 35% center !important; }
      ...
      <main style={{ paddingTop: 72 }}>
        ...
        <div style={{ position: "relative", marginBottom: 48 }}>
          ...
          >
            Kunsten at belyse,<br />hvad der går tabt i processen.
          </h1>
          {/* Scroll-pil */}
          <div
            aria-hidden="true"
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  justifyContent: i < 2 ? "center" : "flex-end",
                  textAlign: i < 2 ? "left" : "center",
                  padding: i < 2 ? "0 32px 0 32px" : "0 32px 32px",
                  zIndex: 10,
                  pointerEvents: "none",
                }}
              >
