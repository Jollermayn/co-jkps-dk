  ...
  return (
    <Link to="/" aria-label="Forside" style={{ display: "inline-flex", lineHeight: 0, textDecoration: "none" }}>
      <svg width={size} height={size} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="16" y="37" textAnchor="middle" fontFamily="serif" fontSize="15" fontWeight="400" fill="#000">P</text>
        <text x="32" y="37" textAnchor="middle" fontFamily="serif" fontSize="15" fontWeight="900" fill="#000">S</text>
      </svg>
    </Link>
  );
}
